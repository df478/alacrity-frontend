            ...
            <div>
                ...
                <p className={allVolumesNames.size ? '' : 'hide-on-demand'}>
                    {localize(
                        ...
                        'Please select the volumes you want to delete. Note that if any of the volumes are being used by other AlaCrity apps, they will not be deleted even if you select them. Deleting volumes takes more than 10 seconds, please be patient'
                    )}
                </p>
                                    ...
                                    content: (
                                        <div>
                                            <p>
                                                ...
                                                done with a delay. Please delete
                                                them manually if needed. Skipped
                                                volumes are:
                                            </p>
                                            <ul>
