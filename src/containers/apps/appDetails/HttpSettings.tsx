...
> {
    ...
    onEditHttpAuthClicked() {
        ...
        const dialogText = localize(
            ...
            'HTTP Basic authentication is the simplest technique for enforcing access controls to web resources. You can use this technique to restrict access to HTTP apps, such as phpMyAdmin and etc.'
        )
            ...
            <div>
                <p>
                    {Utils.formatText(
                        ...
                        ['%s1', '%s2'],
                        [
                            <code>srv-alacran--{app.appName}</code>,
                            <code>{`http://srv-alacran--${app.appName}`}</code>,
                        ]
                    )}
                </p>
                <br />
                ...
                <Tooltip
                    title={Utils.formatText(
                        ...
                        ['%s'],
                        [<span>{`http://srv-alacran--${app.appName}`}</span>]
                    )}
                >
                    <InfoCircleOutlined />
                </Tooltip>
