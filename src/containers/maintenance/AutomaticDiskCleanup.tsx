        ...
        return (
            <div>
                <div>
                    ...
                    <p>
                        {localize(
                            'automatic_disk_cleanup.by_default_alacrity',
                            'By default, AlaCrity keeps a few most recent images for your app so that you can rollback to a previous version if needed. Also, AlaCrity uses a simple crontab scheduler, for example,'
                        )}{' '}
                        <code
                            onClick={(e) => {
