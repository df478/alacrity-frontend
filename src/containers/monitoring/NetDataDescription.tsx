            ...
            <div>
                ...
                <p>
                    {localize(
                        ...
                        'NetData is fast and efficient, designed to permanently run on all systems (physical & virtual servers, containers, IoT devices), without disrupting their core function. The current image of NetData embeded in AlaCrity uses a default configuration for statistics'
                    )}{' '}
                    ...
                    {localize(
                        ...
                        "You can recompile AlaCrity with a different customized image if you'd like."
                    )}
                    .
                </p>
                <p>
                    {localize(
                        'netdata.alacrity_interface',
                        'AlaCrity provides a simple interface to enable NetData on your AlaCrity instance. Currently, AlaCrity only supports installing NetData on your <b>leader node</b>, i.e., the node where AlaCrity instance resides. This limitation is due to a limitation in Docker interface'
                    )}{' '}
