    ...
    constructor(props: any) {
        ...
        this.state = {
            nodeToAdd: {
                ...
                sshPort: '22',
                sshUser: 'root',
                alacranIpAddress: props.leaderIp || '',
                nodeType: 'worker',
                privateKey: '',
            },
        }
                ...
                >
                    <Row justify="space-between">
                        ...
                        <Col lg={{ span: 11 }} xs={{ span: 24 }}>
                            <Input
                                style={{ marginBottom: 10 }}
                                addonBefore={localize(
                                    'add_node.alacrity_ip_address',
                                    'AlaCrity IP Address'
                                )}
                                placeholder="123.123.123.123"
                                type="text"
                                value={nodeToAdd.alacranIpAddress}
                                onChange={(e) =>
                                    self.changeModel(
                                        'alacranIpAddress',
                                        e.target.value
                    ...
                    <Collapse>
                        ...
                        >
                            <p>
                                {localize(
                                    'add_node.alacrity_uses_ssh',
                                    'AlaCrity uses SSH to connect to your nodes and have them join the cluster. Sometimes, this process does not work due to non standard SSH configs such as custom ports, custom usernames, and etc.'
                                )}
                            </p>
                            <p>
                                {localize(
