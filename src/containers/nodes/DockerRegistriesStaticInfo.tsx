            ...
            <div>
                <p>
                    {localize(
                        ...
                        'Setting up Docker Registry is only required if you plan to run your AlaCrity on a cluster. For single node AlaCrity deployments, Docker Registry is not recommended as it makes deployment significantly slower.'
                    )}
                </p>
                <Collapse>
                    <Collapse.Panel
                    ...
                    >
                        ...
                        <p>
                            {localize(
                                ...
                                'AlaCrity provides two methods for you to setup your docker registry:'
                            )}
                        </p>
                        <ul>
                            <li>
                                ...
                                {localize(
                                    ...
                                    'This is the simplest way to setup a docker registry. AlaCrity creates an instance of Docker Registry on the main machine and it manages the registry for you. However, it has its own limitation. If your main machine is destroyed, your local images will be lost. In most cases, this is not a disaster as you can re-deploy your apps from your source code.'
                                )}
                                <br />
                            </li>
                            <li>
