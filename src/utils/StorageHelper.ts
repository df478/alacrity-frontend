...
const AUTH_KEY = 'ALACRITY_AUTH_KEY'
const SIDER_COLLAPSED_STATE = 'ALACRITY_SIDER_COLLAPSED_STATE'
const DARK_MODE = 'ALACRITY_DARK_MODE'
const LANGUAGE = 'ALACRITY_LANGUAGE'
